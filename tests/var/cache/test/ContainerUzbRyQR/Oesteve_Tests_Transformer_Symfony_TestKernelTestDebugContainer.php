 ...
 */
class Oesteve_Tests_Transformer_Symfony_TestKernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Oesteve\\Tests\\Transformer\\Dto\\UserResolver' => 'getUserResolverService',
            'Oesteve\\Transformer\\Transformer' => 'getTransformerService',
        ...
        $this->aliases = [
            'Oesteve\\Tests\\Transformer\\Symfony\\TestKernel' => 'kernel',
        ];
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/Oesteve_Tests_Transformer_Symfony_TestKernelTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'OesteveTransformerBundle' => 'Oesteve\\Transformer\\Symfony\\OesteveTransformerBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'OesteveTransformerBundle' => [
                    'path' => (\dirname(__DIR__, 5).'/lib/Symfony'),
                    'namespace' => 'Oesteve\\Transformer\\Symfony',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'Oesteve_Tests_Transformer_Symfony_TestKernelTestDebugContainer',
