 ...
 */
class getRouting_LoaderService extends Oesteve_Tests_Transformer_Symfony_TestKernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(NULL, 'test');
        ...
        $a->addLoader(new \Symfony\Component\Routing\Loader\ContainerLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'kernel' => 'Oesteve\\Tests\\Transformer\\Symfony\\TestKernel',
        ]), 'test'));
        $a->addLoader($c);
