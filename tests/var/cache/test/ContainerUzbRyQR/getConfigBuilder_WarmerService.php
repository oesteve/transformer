 ...
 */
class getConfigBuilder_WarmerService extends Oesteve_Tests_Transformer_Symfony_TestKernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/framework-bundle/CacheWarmer/ConfigBuilderCacheWarmer.php';
